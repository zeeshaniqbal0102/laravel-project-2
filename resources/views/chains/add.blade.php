...
<div class="page-content-container">
  ...
  <div class="page-content-row">
    <div class="page-content-col">
       <div class="row">
        <div class="col-md-12">
        {!! Form::open([ 'url' => 'chains/add' ,'id' => 'frmAddNew', 'files' => true ]) !!}
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                       ...
                       {{ Form::text('name', old("name"), ['class' => 'form-control','id'=>'name', 'maxlength' => '100']) }} </div>
                     </div>
                    </div>
                  </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group form-md-radios">
                    ...
                    <div class="md-radio-inline">
                      <div class="md-radio">
                        <input type="radio" name="status" value="1" id="statusActive" class="md-radiobtn"{!! ((int)old("status", 1) == 1 ? ' checked="checked"' : '') !!} />
                        <label for="statusActive"> <span></span> <span class="check"></span> <span class="box"></span> Active </label>
                      </div>
                      <div class="md-radio">
                        <input type="radio" name="status" value="0" id="statusDeactive" class="md-radiobtn"{!! ((int)old("status", 1) == 0 ? ' checked="checked"' : '') !!} />
...
<script src="{{ url("resources/assets/scripts/company.js") }}" type="text/javascript"></script>
@endsection